                                ...
                                <table class="table w-full table-zebra">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="w-14">
                                                @if($key3 + 1 == 1 )
                                                    <img class="w-full h-full" src="https://cdn-icons-png.flaticon.com/128/2583/2583344.png" alt="Gold Medal">
                                                @elseif($key3 + 1 == 2 )
                                                    <img class="w-full h-full" src="https://cdn-icons-png.flaticon.com/512/2583/2583319.png" alt="Silver Medal">
                                                @else
                                                    <img class="w-full h-full" src="https://cdn-icons-png.flaticon.com/512/2583/2583434.png" alt="Bronze Medal">
                                                @endif
                                            </td>
                                ...
                                <div class="collapse-content"> 
                                    <table class="table w-full">
                                        ...
                                        <tbody>
                                            ...
                                            @if($competition -> type == "Seirama")
                                             <tr>
                                                 @if($key + 1 == 1 && $key2 + 1 == 5 && $participantMark -> total_marks != 0)
                                                    <th><img class="w-7 h-7" src="https://cdn-icons-png.flaticon.com/128/2583/2583344.png" alt="Gold Medal"></th> 
                                                @elseif($key + 1 == 2  && $key2 + 1 == 5 && $participantMark -> total_marks != 0)
                                                    <th><img class="w-7 h-7" src="https://cdn-icons-png.flaticon.com/512/2583/2583319.png" alt="Silver Medal"></th> 
                                                @elseif($key + 1 == 3  && $key2 + 1 == 5 && $participantMark -> total_marks != 0)
                                                    <th><img class="w-7 h-7" src="https://cdn-icons-png.flaticon.com/512/2583/2583434.png" alt="Bronze Medal"></th> 
                                                 @else
                                                    <th ><div class="ml-2">{{$key + 1}}</div></th> 
                                                 @endif
                                                <td>{{$participantMark -> peserta -> name }} <br> {{ $participantMark -> peserta -> secondName}}</td> 
                                                <td>
                                            ...
                                            <tr>
                                                @if($key + 1 == 1 && $key2 + 1 == 5 && $participantMark -> total_marks != 0)
                                                    <th><img class="w-6 h-6" src="https://cdn-icons-png.flaticon.com/128/2583/2583344.png" alt="Gold Medal"></th> 
                                                @elseif($key + 1 == 2  && $key2 + 1 == 5 && $participantMark -> total_marks != 0)
                                                    <th><img class="w-6 h-6" src="https://cdn-icons-png.flaticon.com/512/2583/2583319.png" alt="Gold Medal"></th> 
                                                @elseif($key + 1 == 3  && $key2 + 1 == 5 && $participantMark -> total_marks != 0)
                                                    <th><img class="w-6 h-6" src="https://cdn-icons-png.flaticon.com/512/2583/2583434.png" alt="Gold Medal"></th> 
                                                 @else
                                                    <th ><div class="">{{$key + 1}}</div></th> 
                                                 @endif
                                                <td>{{$participantMark -> peserta -> name}}</td> 
                                                <td>
                                                    <div class="flex">
