        ...
        <form method="POST" action="/dashboard/competition/{{$competition_id}}/participant">
            ...
            @else
                ...
                <div class="mt-4">
                    ...
                    <x-jet-input id="identity" class="block mt-1 w-full placeholder-gray-400" type="text" name="identity" placeholder="012345001234" :value="old('identity')" required pattern="[0-9]{1,12}" title="Nombor kad pengenalan mestilah digit (0-9) dan tidak boleh lebih daripada 12 digit. "/>
                </div>
            @endif
            <div class="mt-4">
