                ...
                <div class="grid grid-cols-1 gap-6 lg:p-10 xl:grid-cols-3 w-full rounded-box">
                    ...
                    <div class="card shadow-lg side col-span-2  bg-base-100">
                        ...
                        <div class="flex-1">
                            ...
                            <h1 class="card-title text-4xl font-extrabold text-YInMnBlue">@if($competition -> type == "Seirama"){{$participantsCount * 2}}@else {{$participantCount}} @endif</h1>
                            @can("admin")
                            <div class="flex-0">
                                            ...
                                            <div class="modal-box ">
                                                <div class="">
                                                    ...
                                                    <div class=" flex">
                                                        ...
                                                        <div class="">
                                                            <input name="sync_2" class=" w-12 mx-1 rounded-lg @error('sync_1') border-red-700 @enderror" value="{{old('sync_2')}}" type="text" required></input>
                                                        </div>
                                                        <div class="">
                                                            <input name="sync_3" class=" w-12 mx-1 rounded-lg @error('sync_1') border-red-700 @enderror" value="{{old('sync_3')}}" type="text" required></input>
                                                        </div>
                                                        <div class="">
                                                            <input name="sync_4" class=" w-12 mx-1 rounded-lg @error('sync_1') border-red-700 @enderror" value="{{old('sync_4')}}" type="text" required></input>
                                                        </div>
                                                        <div class="">
                                                            <input name="sync_5" class=" w-12 mx-1 rounded-lg @error('sync_1') border-red-700 @enderror" value="{{old('sync_5')}}" type="text" required></input>
                                                        </div>
                                                    </div>
                                                </div>
